...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/waitWindComing/testFramework'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yumanjiang' => 'wwindcoming@163.com' }
  s.source           = { :git => 'https://github.com/waitWindComing/testFramework.git', :tag => s.version.to_s }
